...
use wgpu::{
    ...
    ComputePipelineDescriptor, Device, Extent3d, FilterMode, PipelineLayoutDescriptor, Queue,
...
impl IblBrdf {
    ...
    fn create_empty(
        ...
        const TEXTURE_VIEW_DIMENSIONS: TextureViewDimension = TextureViewDimension::D2;

        let view = texture.create_view(&TextureViewDescriptor {
            label,
            dimension: Some(TEXTURE_VIEW_DIMENSIONS),
            ..Default::default()
        });
        ...
        Self {
            texture: Some(Texture::from_existing(
                texture,
                view,
                sampler,
