...
macro_rules! impl_2_ww {
    ($a:ident, $b:ident) => {
        impl<
            A: Clone + crate::Component,
            B: Clone + crate::Component,
                ...
                Box::new(crate::system::system::FunctionSystem::new(
                    ...
                    Box::new(move |world, _commands| {
                        ...
                        let pivot = if snap_a.dense.len() <= snap_b.dense.len() {
                            snap_a.dense.as_slice()
                        } else {
                            snap_b.dense.as_slice()
                        };
                        for &eid in pivot {
...
macro_rules! impl_2_rr {
    ($a:ident, $b:ident) => {
        impl<A: crate::Component, B: crate::Component, T: FnMut(&A, &B) + Send + 'static>
            ...
            Box::new(move |world, _commands| {
                ...
                for &eid in pivot {
                    if let (Some(ia), Some(ib), Some(ic)) =
                        (snap_a.sparse[eid], snap_b.sparse[eid], snap_c.sparse[eid])
                    {
                        f(
                            &mut snap_a.components[ia],
                            &mut snap_b.components[ib],
    ...
    fn into_system(self) -> Self::System {
        ...
        Box::new(crate::system::system::FunctionSystem::new(
            ...
            Box::new(move |world, _commands| {
                ...
                for &eid in pivot {
                    if let (Some(ia), Some(ib), Some(ic)) =
                        (snap_a.sparse[eid], snap_b.sparse[eid], sc.sparse[eid])
                    {
                        f(
                            &mut snap_a.components[ia],
                            &mut snap_b.components[ib],
    ...
    fn into_system(self) -> Self::System {
        ...
        Box::new(crate::system::system::FunctionSystem::new(
            ...
            Box::new(move |world, _commands| {
                ...
                for &eid in pivot {
                    if let (Some(ia), Some(ib), Some(ic)) =
                        (snap_a.sparse[eid], sb.sparse[eid], snap_c.sparse[eid])
                    {
                        f(
                            &mut snap_a.components[ia],
                            &sb.components[ib],
    ...
    fn into_system(self) -> Self::System {
        ...
        Box::new(crate::system::system::FunctionSystem::new(
            ...
            Box::new(move |world, _commands| {
                ...
                for &eid in pivot {
                    if let (Some(ia), Some(ib), Some(ic)) =
                        (snap_a.sparse[eid], sb.sparse[eid], sc.sparse[eid])
                    {
                        f(
                            &mut snap_a.components[ia],
                            &sb.components[ib],
    ...
    fn into_system(self) -> Self::System {
        ...
        Box::new(crate::system::system::FunctionSystem::new(
            ...
            Box::new(move |world, _commands| {
                ...
                for &eid in pivot {
                    if let (Some(ia), Some(ib), Some(ic)) =
                        (sa.sparse[eid], snap_b.sparse[eid], snap_c.sparse[eid])
                    {
                        f(
                            &sa.components[ia],
                            &mut snap_b.components[ib],
    ...
    fn into_system(self) -> Self::System {
        ...
        Box::new(crate::system::system::FunctionSystem::new(
            ...
            Box::new(move |world, _commands| {
                ...
                for &eid in pivot {
                    if let (Some(ia), Some(ib), Some(ic)) =
                        (sa.sparse[eid], snap_b.sparse[eid], sc.sparse[eid])
                    {
                        f(
                            &sa.components[ia],
                            &mut snap_b.components[ib],
    ...
    fn into_system(self) -> Self::System {
        ...
        Box::new(crate::system::system::FunctionSystem::new(
            ...
            Box::new(move |world, _commands| {
                ...
                for &eid in pivot {
                    if let (Some(ia), Some(ib), Some(ic)) =
                        (sa.sparse[eid], sb.sparse[eid], snap_c.sparse[eid])
                    {
                        f(
                            &sa.components[ia],
                            &sb.components[ib],
    ...
    fn into_system(self) -> Self::System {
        ...
        Box::new(crate::system::system::FunctionSystem::new(
            ...
            Box::new(move |world, _commands| {
                ...
                for &eid in pivot {
                    if let (Some(ia), Some(ib), Some(ic)) =
                        (sa.sparse[eid], sb.sparse[eid], sc.sparse[eid])
                    {
